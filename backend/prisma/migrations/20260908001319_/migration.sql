...
-- CreateEnum
CREATE TYPE "Continent" AS ENUM ('NORTH_AMERICA', 'SOUTH_AMERICA', 'EUROPE', 'AFRICA', 'ASIA', 'OCEANIA');
...
CREATE TABLE "listings" (
    ...
    "continent" "Continent" NOT NULL DEFAULT 'EUROPE',
...
-- CreateIndex
CREATE INDEX "listings_continent_idx" ON "listings"("continent");
...
-- CreateIndex
CREATE INDEX "hotels_continent_idx" ON "hotels"("continent");

-- CreateIndex
CREATE INDEX "restaurants_continent_idx" ON "restaurants"("continent");
