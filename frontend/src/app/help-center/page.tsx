...
export const metadata: Metadata = {
  title: "Help Center",
  description: "Help Center on TripNest."
};

// Real route now exists so the footer's Help Center link isn't a dead end —
// but there's no real Help Center content yet, so this is an honest "coming
