...
export const metadata: Metadata = {
  title: "Blog",
  description: "Blog on TripNest."
};

// Real route now exists so the footer's Blog link isn't a dead end —
// but there's no real Blog content yet, so this is an honest "coming
