...
**Destinations**
- `DestinationsSection` / `DestinationsCarousel` show `data/natGeoDestinations.ts` — a static, curated list of National Geographic's real "Best of the World 2026" destinations (verified against the actual published list; descriptions are written in our own words, with an attribution link). This is editorial content, not TripNest's own data.
