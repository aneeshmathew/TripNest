...
- No active search/filter → full marketing front door: `Hero`, `DestinationsSection`, `FeaturedStays`, `EasyToUseSection`, `PlanWithFriendsSection`, `RecommendationsSection`, `FaqSection`, `TestimonialSection`, `DestinationGallery`.
